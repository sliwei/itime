  ...
  return (
    <div className="h-full">
      <div className="fixed w-full h-full top-0 z-0 bg-repeat">
        ...
        <div className="relative z-10 p-[20px] text-white">
      ...
      <div className="relative z-10 bg-white h-full rounded-[10px] overflow-hidden shadow-yellow-600 m-[10px] p-[10px]">
        <div className="absolute w-[2px] h-[88%] bg-black left-[20px]"></div>
        <div className="absolute w-[2px] h-[88%] bg-black left-[20px] origin-center rotate-1"></div>

        <div className="py-[10px] text-[30px]">
          {/* 时间 */}
          <div className="flex justify-start items-center">
            <div className="bg-green-700 px-[10px] ml-[-10px] relative flex_center flex-col">
              <div className="absolute w-full h-full border-[2px] border-[#000] border-solid left-0 top-0 skew-x-6 origin-top-left rotate-1"></div>
          ...
          <div className="flex pl-[40px] my-[20px] flex-wrap">
            <div className="w-[210px] h-[140px] border-[2px] border-[#000] border-solid rounded-[20px] mr-[4px] mb-[4px] relative">
              <div className="absolute w-full h-full border-[2px] border-[#000] border-solid left-0 top-0 skew-x-2 origin-top-left rotate-1"></div>
              <img
        ...
        <div className="py-[10px] text-[30px]">
          {/* 时间 */}
          <div className="flex justify-start items-center">
            <div className="bg-green-700 min-h-[20px] min-w-[20px] px-[10px] ml-[-10px] relative flex_center flex-col">
              <div className="absolute w-full h-full border-[2px] border-[#000] border-solid left-0 top-0 skew-x-6 origin-top-left rotate-1"></div>
              {/* <p className="leading-[1]">7月</p>
              <p className="leading-[1]">15日</p> */}
            </div>
      ...
      <div className="fixed z-20 bottom-[20px] w-full left-0 h-[100px]">
        <div className="w-[80%] h-full rounded-full bg-[#3D1E67] flex justify-evenly m-auto">
      ...
      <AnimatePresence>
        ...
        {open === 0 ? (
          ...
          >
            <div className="flex-1 bg-white rounded-[10px] m-[10px] relative border-black border-[2px] border-solid">
              <div className="absolute w-full h-full border-[2px] border-[#000] border-solid left-0 top-0 origin-top-left rotate-1"></div>
              信息ℹ️
            </div>
