...
export default function Index() {
  ...
  return (
    <div style={{ fontFamily: 'HYYouYuan-65W' }}>
      ...
      <AnimatePresence>
        {isLock === 1 && open === -1 ? (
          <motion.div {...fullAnimate2} className="fixed z-20 bottom-[20px] w-full left-0 h-[100px]">
            <div className="w-[80%] h-full rounded-full bg-[#f3818150] backdrop-blur-xl flex justify-evenly m-auto">
              <div className="w-[60px] h-full rounded-full flex_center">
                <img onClick={() => setOpen(0)} className="anim_btn h-[60px] object-cover" src={tipsImg} alt="" />
              </div>
              <div className="w-[60px] h-full rounded-full flex_center">
                <img onClick={() => setOpen(1)} className="anim_btn h-[60px] object-cover" src={editionImg} alt="" />
              </div>
              <div className="w-[60px] h-full rounded-full flex_center">
                <img onClick={() => setOpen(2)} className="anim_btn h-[60px] object-cover" src={settingsImg} alt="" />
              </div>
            </div>
          </motion.div>
        ) : null}
      ...
      <ToastContainer className="toast-container text-[24px]" toastClassName="toast-class" bodyClassName="toast-body-class" />
    </div>
  )
}
